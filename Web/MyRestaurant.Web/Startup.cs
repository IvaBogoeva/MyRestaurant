                ...
                endpoints =>
                    {
                        ...
                        endpoints.MapControllerRoute("myRestaurantCategory", "f/{name:minlength(3)}", new
                        { controller = "Categories", action = "ByName", });
